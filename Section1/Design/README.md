...
This is complementary material for section 1.3 (The Function Design Recipe) of the CSC148 course. Here, we want to see the process of coding a function that will be used in this beautiful, circular solar system visualization! Here's what we are asked to do:
